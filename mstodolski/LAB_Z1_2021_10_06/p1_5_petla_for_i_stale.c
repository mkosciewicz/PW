...
{	/* wyświetlanie to wołanie funcji printf (stdio.h) z parametrami */
	...
	*/
	...
	printf("Wynik dzialania (2*5+4)=%d a stala 6 jest rowna %d",i,Stala6); /* jest to polecenie więc musi mieć średnik na końcu */
	...
	*/
	...
	for( i=0; i < N; ++i /* zzwiększ wartość i o 1 to samo co i = i + 1 */)
	{	printf("\nwartosc i w petli wynosi %d", i);	
